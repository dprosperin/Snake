...
def show_score(choice, color, font, size, myscore, left):
...
while True:
    ...
    show_score(1, blue, 'times new roman', 20, score, 0)
    show_score(1, red, 'times new roman', 20, score2, 100)
